...
export async function reviewTransportRequest(
  ...
  // ADD HERE
  console.log("approval form data", {
    requestId,
    decision,
    comment,
  ...
  // ADD HERE
  console.log("request fetch result", { request, requestError });
  ...
  // ADD HERE
  console.log("approval upsert result", { approvalError });
  ...
  // ADD HERE
  console.log("request update result", { requestUpdateError });
